...
Standalone skill for catalysis-relevant DFT result analysis, now with cross-backend energy support and adsorption-selectivity comparison.
...
python3 scripts/compare_catalyst_set.py fixtures fixtures/candidates/strong-bind --json
